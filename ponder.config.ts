...
export const LEVERAGED_TOKENS: Address[] = [
...
export default createConfig({
  chains: {
    ...
    hyperEvmAlchemy: {
      id: 1000,
      rpc: "https://hyperliquid-mainnet.g.alchemy.com/v2/75srotfitX8AQCM8plC_z",
    },
  },
  blocks: {
    PerBlockUpdate: {
